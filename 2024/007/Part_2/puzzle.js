...
var FILEPATH = "2024/007/Part_2/input.txt";
var Operations;
(function (Operations) {
    Operations[Operations["ADD"] = 0] = "ADD";
    Operations[Operations["MULT"] = 1] = "MULT";
    Operations[Operations["CONCAT"] = 2] = "CONCAT";
...
for (var _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
    ...
    var operationList = generatePermutations([Operations.ADD, Operations.MULT, Operations.CONCAT], equation.length - 1);
